...
- **Lua rule pack** (`references/lua.md`): detection via `.rockspec`/`lua_modules/`/`.luacheckrc`, LÃ–VE2D/Neovim/OpenResty/WoW Addon/etc. classification, LuaRocks dependency analysis.
