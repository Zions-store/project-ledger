...
### game-design-doc-governance (v1.0.0) — Stable

Reusable governance framework for game design documentation. Genre profiles, authority boundaries, change-safety anchors, data-driven Python audit, issue-state tracking, and a scaffold tool (`gdd-audit` / `gdd-profile-validate` / `gdd-scaffold`).

- **Trigger phrases**: "set up design docs", "game design documentation", "audit design docs"
- **Requires**: Python 3.9+, `pip install -e .` (deps: `pyyaml`, `jsonschema`)
- **Features**: 10 genre profiles, 16 doc-module skeletons, 6 self-contained regression fixtures, 4 JSON schemas, pytest 22/22, `docs/` 10 guides
...
project-docs       →  PROJECT_STATE.md  (track status)
     ...
     ↓
gdd-governance     →  Design_Document.md + STYLE_GUIDE.md + ...
                   →  gdd-audit / gdd-profile-validate / gdd-scaffold
```
...
mklink /J %USERPROFILE%\.config\opencode\skills\game-design-doc-governance  project-ledger\game-design-doc-governance
